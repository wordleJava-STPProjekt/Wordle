...
import static com.wordle.wordle.MainApplication.dictionaryWords;
import static com.wordle.wordle.MainApplication.winningWords;

public class MainHelp {

    private static MainHelp INSTANCE = null;
